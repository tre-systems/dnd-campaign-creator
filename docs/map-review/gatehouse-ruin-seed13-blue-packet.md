...
| --- | --- |
| Dimensions | 30 x 44 |
| Density | 45% floor coverage (standard) |
| Rooms | 9 |
| Corridors | 12 |
...
**1. Boss Room** (8x18, large)
- Occupants: Hobgoblin boss + 1 bodyguard
- Type: faction-core
- Sightline: open
- Retreat: X1

**2. Guard Post** (7x7, medium)
- Occupants: 2 goblin sentries
- Type: guard
- Sightline: partial
- Retreat: H1

**3. Gatehouse Hall** (7x6, medium)
- Type: hub
- Sightline: open
- Retreat: R1, R3, F1

**4. Collapsed Gate** (6x7, medium)
- Type: entry
- Sightline: open
- Retreat: G1

**5. Kitchen/Well** (8x5, medium)
...
**7. Barracks** (3x3, small)
- Occupants: 4 goblins
- Type: standard
- Sightline: blocked
- Retreat: H1

**8. Old Vault** (4x3, small)
- Type: secret
- Sightline: blocked

**9. Stairs Down** (3x3, small)
- Type: exit
- Sightline: partial
- Retreat: R3, F1
