...
| ---------- | ----------------------------- |
| Dimensions | 30 x 44                       |
| Density    | 44% floor coverage (standard) |
| Rooms      | 9                             |
| Corridors  | 12                            |
...
![Goblin-occupied dwarven gatehouse Map](./gatehouse-ruin-seed99-blue-v4.svg)
...
**3. Collapsed Gate** (6x4, medium)

- Type: entry
- Sightline: open
- Retreat: G1

**4. Gatehouse Hall** (6x6, medium)

- Type: hub
- Sightline: open
- Retreat: R1, R3, F1

**5. Kitchen/Well** (7x6, medium)
...
**7. Stairs Down** (4x5, small)

- Type: exit
- Sightline: partial
- Retreat: R3, F1

**8. Barracks** (3x3, small)
