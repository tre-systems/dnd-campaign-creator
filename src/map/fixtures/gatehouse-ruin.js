...
function createSunkenSanctumSection() {
  return {
    ...
    nodes: [
      ...
      { id: "R2", type: "standard", name: "Drain Gallery", sizeClass: "medium" },
      { id: "R3", type: "standard", name: "Chapel of Tides", sizeClass: "medium" },
      { id: "R4", type: "standard", name: "Well Shaft", sizeClass: "small" },
      { id: "B1", type: "faction-core", name: "Sunken Throne", sizeClass: "large" },
      { id: "S1", type: "secret", name: "Crypt Annex", sizeClass: "small" },
      { id: "Z1", type: "hazard", name: "Broken Weir", sizeClass: "medium" },
      { id: "T1", type: "set-piece", name: "Forge of Chains", sizeClass: "large" },
      { id: "X1", type: "exit", name: "Spiral Descent", sizeClass: "small" },
    ],

    edges: [
      { from: "E1", to: "G1", type: "door", bidirectional: true, width: "standard" },
      { from: "E1", to: "H1", type: "open", bidirectional: true, width: "standard" },
      { from: "G1", to: "H1", type: "open", bidirectional: true, width: "standard" },

      { from: "H1", to: "R1", type: "open", bidirectional: true, width: "standard" },
      { from: "R1", to: "R2", type: "open", bidirectional: true, width: "tight" },
      { from: "R2", to: "X1", type: "open", bidirectional: true, width: "standard" },

      { from: "H1", to: "R3", type: "door", bidirectional: true, width: "standard" },
      { from: "R3", to: "R4", type: "open", bidirectional: true, width: "tight" },
      { from: "R4", to: "X1", type: "open", bidirectional: true, width: "standard" },

      { from: "H1", to: "B1", type: "locked", bidirectional: true, width: "wide" },
      { from: "B1", to: "S1", type: "secret", bidirectional: true, width: "tight" },
      { from: "S1", to: "R2", type: "secret", bidirectional: true, width: "tight" },

      { from: "H1", to: "Z1", type: "open", bidirectional: true, width: "tight" },
      { from: "Z1", to: "T1", type: "one-way", bidirectional: false, width: "standard" },
      { from: "T1", to: "X1", type: "door", bidirectional: true, width: "wide" },
      { from: "R1", to: "T1", type: "door", bidirectional: true, width: "standard" },
      { from: "R3", to: "B1", type: "open", bidirectional: true, width: "standard" },
    ],
...
function createClockworkArchiveSection() {
  return {
    ...
    nodes: [
      ...
      { id: "G1", type: "guard", name: "Antechamber Guard", sizeClass: "small" },
      { id: "H1", type: "hub", name: "Great Hall of Gears", sizeClass: "large" },
      { id: "H2", type: "hub", name: "Archive Nexus", sizeClass: "medium" },
      { id: "R1", type: "standard", name: "Library Stacks", sizeClass: "medium" },
      { id: "R2", type: "standard", name: "Scriptorium Annex", sizeClass: "small" },
      { id: "R3", type: "resource", name: "Clockwork Well", sizeClass: "small" },
      { id: "R4", type: "standard", name: "Chapel of Brass", sizeClass: "medium" },
      { id: "R5", type: "standard", name: "Smelting Forge", sizeClass: "large" },
      { id: "R6", type: "hazard", name: "Arc Coil", sizeClass: "medium" },
      { id: "R7", type: "set-piece", name: "Observatory Gallery", sizeClass: "large" },
      { id: "F1", type: "faction-core", name: "Regent Throne", sizeClass: "large" },
    ...
    edges: [
      { from: "E1", to: "G1", type: "door", bidirectional: true, width: "standard" },
      { from: "E1", to: "H1", type: "open", bidirectional: true, width: "standard" },
      { from: "G1", to: "H1", type: "open", bidirectional: true, width: "tight" },

      { from: "H1", to: "H2", type: "open", bidirectional: true, width: "wide" },
      { from: "H1", to: "R1", type: "door", bidirectional: true, width: "standard" },
      { from: "R1", to: "R2", type: "open", bidirectional: true, width: "standard" },
      { from: "R2", to: "X2", type: "one-way", bidirectional: false, width: "tight" },

      { from: "H2", to: "R3", type: "open", bidirectional: true, width: "standard" },
      { from: "H2", to: "R4", type: "door", bidirectional: true, width: "standard" },
      { from: "R4", to: "F1", type: "locked", bidirectional: true, width: "wide" },
      { from: "F1", to: "S1", type: "secret", bidirectional: true, width: "tight" },
      { from: "S1", to: "R2", type: "secret", bidirectional: true, width: "tight" },

      { from: "H2", to: "R5", type: "open", bidirectional: true, width: "wide" },
      { from: "R5", to: "R6", type: "open", bidirectional: true, width: "standard" },
      { from: "R6", to: "X1", type: "open", bidirectional: true, width: "standard" },

      { from: "H2", to: "R7", type: "open", bidirectional: true, width: "standard" },
      { from: "R7", to: "X1", type: "door", bidirectional: true, width: "standard" },
      { from: "R3", to: "R6", type: "door", bidirectional: true, width: "tight" },
      { from: "R1", to: "R3", type: "open", bidirectional: true, width: "standard" },
      { from: "R5", to: "F1", type: "door", bidirectional: true, width: "standard" },
    ],
